...
export function SharinganDesigner() {
  ...
  useEffect(() => {
    ...
    const designs = JSON.parse(
      window.localStorage.getItem(SAVED_DESIGNS_KEY) || '[]'
    )
            ...
            <Card className="p-4">
              ...
              <div className="space-y-2">
                ...
                <Slider
                  ...
                  onValueChange={([value]) =>
                    setSymmetrySettings((prev) => ({ ...prev, axes: value }))
                  }
                  min={2}
                  max={6}
                  step={1}
              ...
              <div className="space-y-2">
                ...
                <Slider
                  ...
                  onValueChange={([value]) =>
                    setColorSettings((prev) => ({ ...prev, pupilSize: value }))
                  }
                  min={0.05}
                  max={0.3}
                  step={0.01}
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="flex items-center gap-2">
                  <Select
                    ...
                    onValueChange={(value) =>
                      setCurrentPathIndex(Number.parseInt(value))
                    }>
            ...
            <Card className="p-4 space-y-4">
              ...
              <div className="space-y-3">
                ...
                <RadioGroup
                  ...
                  onValueChange={(value) =>
                    setColorSettings((prev) => ({ ...prev, pupilColor: value }))
                  }
